...
const RATE_GBR_USD = 1.4;

function convertToUSD(priceGBR) {
  return priceGBR * RATE_GBR_USD;
}
...
const RATE_BRL_USD = 5.7;
const FEE = 1;

function convertToBRL(priceGBR) {
  return (priceGBR * (100 - FEE)) / 100 * RATE_BRL_USD;
}
